...
io.on('connection', (socket) => {
    ...
    socket.on("save_info", (arg) => {
        ...
        con.connect(function (err) {
            ...
            var sql = "INSERT INTO sinhvien (name, mssv, ngaysinh, gioitinh, nganh, diachi, email) VALUES ('" + info.name + "','" + info.mssv + "','" + info.ngaysinh + "','" + info.gioitinh + "','" + info.nganh + "','" + info.diachi + "','" + info.email + "')";
    ...
    socket.on("find_student", (mssv, name, tinh) => {
       // console.log(arg);
        ...
        con.connect(function (err) {
            ...
            var sql = 'SELECT * FROM sinhvien WHERE mssv LIKE ' + mysql.escape(mssv) 
